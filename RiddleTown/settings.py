"""
Django settings for RiddleTown project.
...
SECRET_KEY = 'django-insecure-_vg0s9$rr8p_c4(989d0%3lic^wc)gjw%a*ut#r22id5*-xt%1'
...
TEMP_DIR = os.path.join(BASE_DIR, 'mainapp')
...
WSGI_APPLICATION = 'RiddleTown.wsgi.application'
